...
Some learnings:
  ...
  - Binary KRs (pass/fail/delivery) are fine, especially for Objectives that neet to be met.
...
Some takeaways:
  ...
  - Shield teams from politics and unecessary stress. However, not from all stress: clearly communicate priorities and business imperatives.
...
Beware false fails, sometimes your test can be wrong. (And a good idea has to die at least 3 times. Debatable but interesting idea).
...
Good companies nurture loonshots AND franchises
  ...
  - nurture both types of loonshots: strategic and product.
...
Sometimes you'll invite a completely new product, somethings you'll invent a new optimal way to do things.

### Kasparov on the outcome vs strategic mindset
  - **Outcome** Analyse why a move is bad. Why did pawn taking bishop lose the game?
  - **Mindset** Analys why you decided to make that move. What was the process and how can you change it?

## Culture Code
![Culture Code](../images/book_culture_code.jpg)

  - Form a safe environment so people are less defensive and cooperate.
  - Share your shortcomings to show it's ok to make mistakes. 
  - Build a sense of purpose thought a shared goal and a simple way towards it. (Sounds familiar? See Start with Why, and Measure what matters.)


## INTERLUDE
So far from the book we've reviewed, we have a few recurring themes:
...
The two main ideas from Team of Teams are that your organization should have a shared consciousness and that it should empower individual contributors to executre, so long as they keep leadership informed. This is something that we implement at Unito using AoRs and asynchronous overcomunication.
  ...
  - Leadership thought process should be transparent so that the team understand (and offer feedback) as to how the org operates. (Links with the Strategic Mindset approach from Loonshots/Kasparov).
...
Radical Candor revolves around the idea of combining caring for people while also challenging directly to lead efficiently and with empathy. It touches principles such as feedback (criticize in private, praise in public) and frequency (offering feedback asap is usually more effective).
  ...
  - Getting stuff done: listen to ideas from your team; clarify to make sure everyone undestands; debate; decide; persuate that it was the proper idea; execute; learn.
...
![Principles](../images/book_principes.jpg)
  ...
  - Creating principles: write down encounters you have, how many you have, what you should do to handle it. Update as you get more data and test assumptions. Record why you made certain decisions and revise. *This echoes strategic vs outcome mindset mentionned by Loonshots and Kasparov* . Consider second and third order consequences.
  ...
  - Work principles: trust in radical truth and transparency; culture where it's ok to make mistakes but not to not learn from them; get and stay in sync; constantly train, test, evaluate and sort people.
  - Meritocracy requires that: people put their honest thoughts ont he table; have thoughtful disagreements; abide by idea-merid ways of getting past disagreements.
...
![Leaders eat last](../images/leaders_eat_last.jpg)
  ...
  - Stress is not caused by pressure and responsabilities, but rather by lack of control.
